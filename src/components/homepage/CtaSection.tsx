...
export default function CtaSection() {
  return (
    <section className="relative bg-[#050505] py-24" id="contact">
      ...
      <div className="mx-auto max-w-[1400px] px-6 md:px-10">
        <div className="relative overflow-hidden rounded-3xl border border-white/8 bg-linear-to-br from-[#050505] via-[#090909] to-dark-card px-6 py-8 md:px-10 md:py-10">
          ...
          <div className="grid grid-cols-12 gap-8 md:gap-10 items-center">
            ...
            <Reveal delayMs={120} className="col-span-12 md:col-span-5 lg:col-span-4">
              <div className="rounded-2xl border border-white/10 bg-white/3 p-5 md:p-6">
                <p className="text-[11px] text-white/60">
                  Install the package, import the stylesheet, and you&apos;re ready to ship real product
